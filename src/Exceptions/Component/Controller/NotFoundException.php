...
/**
 * Component Controller Not Found Exception
 *
...
namespace AdeptCMS\Exceptions\Component\Controller;
...
{
  function __construct(string $component, string $controller, string $namespace, string $file)
  {
    ...
    if (DEBUG) {
      ...
      $out .= '<dt>Controller</dt>';
      $out .= '<dd>' . $controller . '</dd>';
