...
class Countries extends \Adept\Abstract\Component\HTML\Items
{
  /**
  ...
  public function getTable(): \Adept\Data\Table\Location\Country
  {
    $get   = Application::getInstance()->session->request->data->get;
    $table = new \Adept\Data\Table\Location\Country();

    if (!empty($country = $get->getString('country'))) {
